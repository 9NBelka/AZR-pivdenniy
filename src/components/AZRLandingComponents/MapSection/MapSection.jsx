      ...
      <div className={scss.container}>
        ...
        <div className={scss.mapAndTextBlocks}>
          <div className={scss.mapBlock}>
            <iframe
              src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d539.3123850258023!2d36.205758802125274!3d49.984800295042724!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4127a123783a6f4b%3A0xac80806aed8fe16a!2z0KHQotCeINCQ0JfQoCDQn9GW0LLQtNC10L3QvdC40Lk!5e0!3m2!1sru!2sua!4v1768950221573!5m2!1sru!2sua'
              allowfullscreen=''
              loading='lazy'></iframe>
          </div>
          <div className={scss.textsBlock}>
            <div className={scss.textsBlockAndIcon}>
              ...
              <div className={scss.blockTextColumn}>
                <h3>Адреса</h3>
                <p>м. Харків, вул. Гвардійців-залізничників 15</p>
              </div>
            </div>
